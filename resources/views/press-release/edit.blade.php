                    ...
                    <form class="row g-3" action="{{ route('press-release.update', $press_release->id) }}" method="POST"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('title_am') _incorrectly @enderror"
                                id="title_am" name="title_am" value="{{ $press_release->title_am}}">
                            @error('title_am')
                            <div class="error_message"> {{ $message }} </div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('title_am') _incorrectly @enderror"
                                id="title_ru" name="title_ru" value="{{ $press_release->title_ru}}">
                            @error('title_ru')
                            <div class="error_message"> {{ $message }} </div>
                            @enderror
                        </div> --}}
                        <div class="col-6">
                            ...
                            <input type="date" class="form-control @error('date') _incorrectly @enderror" id="date"
                                name="date" value="{{$press_release->date}}">
                            @error('date')
                            <div class="error_message"> {{ $message }} </div>
                            @enderror
                        </div>
                        <div class="col-6">
                            ...
                            <input type="time" class="form-control @error('time') _incorrectly @enderror" id="time"
                                name="time" value="{{ $press_release->time}}">
                            @error('time')
                            <div class="error_message"> {{ $message }} </div>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea class="ckeditor form-control @error('description_ru') _incorrectly @enderror"
                                name="description_ru" id="description_ru">{{ $press_release->description_ru}}</textarea>
